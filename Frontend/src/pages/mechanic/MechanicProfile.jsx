...
const MechanicProfile = () => {
  ...
  const handleSave = async () => {
    try {
      const response = await mechanicProfileService.updateProfile(formData);
  ...
  return (
    <div className="container py-4">
      <h3 className="fw-bold mb-4">Mechanic Profile</h3>
          ...
          <div className="row align-items-center">
            ...
            <div className="col">
              ...
              <div className="badge bg-primary-subtle text-primary px-3 py-2">
                Joined On {formatDate(profile.memberSince)}
              </div>
            </div>
        ...
        <div className="col-md-3">
          <div className="card border-0 shadow-sm">
            <div className="card-body text-center">
              ...
              <h2 className="fw-bold">{profile.totalAssignedJobs}</h2>
            </div>
          </div>
        </div>
        ...
        <div className="col-md-3">
          <div className="card border-0 shadow-sm">
            <div className="card-body text-center">
              ...
              <h2 className="fw-bold">{profile.completedJobs}</h2>
            </div>
          </div>
        </div>
